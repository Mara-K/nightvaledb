    ...
    <pattern>
        ...
        <rule context="ref[@type='group']">
            <assert
               ...
               ,"tinyPeople","tourismBoard","nra","tourismBoard","boyScouts","animalControl")'> Specific value should be a group or organization. </assert>
        </rule>
        <rule context="ref[@type='place']">
            <assert
               ...
               ,"stationOffice","darkBox")'> Specific value should be a place. </assert>
        </rule>
        <rule context="ref[@type='culture']">
            <assert test='@spec=("gatorade","arbys","cocaCola")'> Specific value should be a cultural icon. </assert>
        </rule>
        <rule context="ref[@type='object']">
            <assert
                ...
                ,"sports","carlosFace","bread","salt","ghostCar","animalPyre","umbrella","vanilla","newspaper","milk","envelope"
                ,"teeth","trash","flag","book")'>
                Specific value should be an object. </assert>
        </rule>
        <rule context="ref[@type='language']">
            <assert test='@spec=("spanish","russian")'> Specific value should be a language.
            </assert>
        </rule>
        <rule context="ref[@type='abstract']">
            <assert
                test='@spec=("science","health","art","love","earthquake","void","insurance","war","hoodedFigureParade"
               ,"weather","sports" ,"visitable","death","education")'> Specific value should be an abstract concept. </assert>
        </rule>
    </pattern>
</schema>
